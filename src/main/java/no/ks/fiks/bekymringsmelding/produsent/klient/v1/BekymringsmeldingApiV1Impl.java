...
public class BekymringsmeldingApiV1Impl implements BekymringsmeldingApiV1 {
    ...
    public BekymringsmeldingApiV1Impl(Client client, String baseUrl, Maskinportenklient maskinporten, UUID fiksOrgId, String integrasjonId, String integrasjonPassord) {
        this.client = client;
